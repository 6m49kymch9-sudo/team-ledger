...
import { ArrowLeft, ImageIcon, Loader2, TrendingUp } from 'lucide-react'
  ...
  return (
    <div className="p-4 lg:p-6 max-w-2xl mx-auto pb-20 lg:pb-6">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl font-bold">新增收入</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="relative">
              <span className="absolute left-4 top-1/2 -translate-y-1/2 text-2xl text-green-600 font-bold">
                +¥
              </span>
              <Input
                type="number"
                ...
                className="pl-10 text-3xl h-14 font-bold border-2 focus:border-green-600"
                autoFocus
              />
            </div>
          </CardContent>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setFormData({ ...formData, category: value || 'other_income' })}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
        ...
        <div className="flex gap-3">
          <Link href="/app/incomes" className="flex-1">
